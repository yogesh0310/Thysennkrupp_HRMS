                        ...
                        <div class="col s12 m12 ">
                          <div class="card white">
                            <div class="card-content blue-text">
                                    ...
                                    <a href="http://10.128.17.99/createusers.php">
                                            <div class="col  m6 s6">
...
<!--
                                        <a href="http://10.128.17.99/createdepartment.php">
                                            <div class="col  m6 s6">
                                        ...
                                        <div class="row" id="cardsradius">
                                        <a href="http://10.128.17.99/createiid.php">
                                            <div class="col  m6 s6">
                                        ...
                                        <a href="http://10.128.17.99/initiateround.php">
                                            <div class="col  m6 s6">
                                        ...
                                        <a href="http://10.128.17.99/allocateround.php">
                                            <div class="col  m6 s6">
                                        ...
                                        <a href="http://10.128.17.99/allocateround2.php">
                                            <div class="col  m6 s6">
                                              <div class="card " style="background: #9F44D3;">
                                                <div class="card-content white-text">
...
-->
                                    ...
                                    <a href="http://10.128.17.99/showusers.php">
                                            <div class="col  m6 s6">
                                              <div class="card " style="background: orange">
                                                <div class="card-content white-text">
...
$.ajax({
url:"http://10.128.17.99/api/logout.php",
type:"POST",
...
$("#row").hide()
$("#logout").show()
document.location.replace("http://10.128.17.99/index.php")
}
else
{
$("#notlogout").show()
document.location.replace("http://10.128.17.99/")
}
} 
